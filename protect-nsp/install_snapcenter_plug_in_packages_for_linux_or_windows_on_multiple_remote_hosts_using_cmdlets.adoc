...
---
= cmdlet을 사용하여 여러 원격 호스트에 Linux, Windows 또는 AIX용 SnapCenter 플러그인 패키지를 설치합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Install-SmHostPackage PowerShell cmdlet을 사용하여 여러 호스트에 Linux, Windows 또는 AIX용 SnapCenter 플러그인 패키지를 동시에 설치할 수 있습니다.
