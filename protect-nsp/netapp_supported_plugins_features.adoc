...
[role="lead"]
SnapCenter는 플러그인 애플리케이션 및 스토리지 시스템의 NetApp 기술과 통합됩니다. MongoDB, ORASCPM(Oracle Applications), SAP ASE, SAP MaxDB 및 스토리지 플러그인과 같은 NetApp 지원 플러그인을 사용하려면 SnapCenter 그래픽 사용자 인터페이스를 사용해야 합니다.
...
NetApp 지원 플러그인은 다음과 같은 이점을 제공합니다.
