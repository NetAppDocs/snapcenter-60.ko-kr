...
+
** image:../media/controller_licensed_icon.gif["확인 아이콘"] FAS, AFF 또는 ASA 운영 스토리지 시스템에 SnapManager 제품군 라이센스가 설치되어 있음을 나타냅니다.
** image:../media/controller_not_licensed_icon.gif["취소 아이콘"] FAS, AFF 또는 ASA 운영 스토리지 시스템에 SnapManager 제품군 라이센스가 설치되어 있지 않음을 나타냅니다.
